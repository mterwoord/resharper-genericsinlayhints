...
[RegisterHighlighterGroup(HighlightAttributeGroupId,
...
public class GenericsInlayHint: GenericsInlayHintBase
{
    ...
    public const string HighlightAttributeId = nameof(GenericsInlayHint);

    public GenericsInlayHint(string parameterName, ITreeNode node, DocumentOffset offset, string tooltip)
